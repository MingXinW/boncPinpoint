 ...
 */
public class EsUdpDispatchHandler extends AbstractDispatchHandler {

    @Autowired()
    @Qualifier("esAgentStatHandler")
    private Handler esAgentStatHandler;


    public EsUdpDispatchHandler() {
